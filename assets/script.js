document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    .getElementById("seattle-button")
    .addEventListener("click", function () {
      getWeatherData("Seattle");
    });

  document
    .getElementById("portland-button")
    .addEventListener("click", function () {
      getWeatherData("Portland");
    });
  document
    .getElementById("duluth-button")
    .addEventListener("click", function () {
      getWeatherData("Duluth");
    });

  document
    .getElementById("miami-button")
    .addEventListener("click", function () {
      getWeatherData("Miami");
    });

  document
    .getElementById("chicago-button")
    .addEventListener("click", function () {
      getWeatherData("Chicago");
    });

  document
    .getElementById("boston-button")
    .addEventListener("click", function () {
